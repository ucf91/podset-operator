...
//+kubebuilder:rbac:groups=agent.instana.com,resources=podsets,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=agent.instana.com,resources=podsets/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=agent.instana.com,resources=podsets/finalizers,verbs=update
...
func newPodForCR(cr *agentv1.PodSet) *corev1.Pod {
